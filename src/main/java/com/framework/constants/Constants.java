 ...
 * 
 */
package main.java.com.framework.constants;
...
public class Constants {
	...
	public static class DownloadExcelFileHelperConstants {
		public static final StringBuffer EXCELFILEPATH = new StringBuffer("1Plq_dZDF3mPJdpYe_s4MuukJewR5lYBr");
		...
		public static final StringBuffer APPLICATIONNAME = new StringBuffer("API Automation");
	...
	public static class ExcelColumnNameConstant {
		...
		public static final StringBuffer NumericOperationOnExtractValue = new StringBuffer("calculate values");
	...
	public static class RestUtilConstant {
		public static final StringBuffer RESTUTILCLASSNAME = new StringBuffer(
				"main.java.com.framework.utility.GetJsonValuesFromResponse");
	}
